...
public class MediaRendererSubscriptionCallback extends BaseSubscriptionCallback {

    private static final String TAG = MediaRendererSubscriptionCallback.class.getSimpleName();

    public MediaRendererSubscriptionCallback(org.teleal.cling.model.meta.Service service, Context context) {
        super(service, context);
    }

    @Override
    protected void eventReceived(GENASubscription subscription) { // 这里进行 事件接收处理
        Log.i(TAG, "SubscriptionMediaRenderer:" + subscription.toString());
