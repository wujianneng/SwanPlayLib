...
public class OutgoingSearchRequestMDNS extends OutgoingDatagramMessage<UpnpRequest> {
    private UpnpHeader searchTarget;

    public OutgoingSearchRequestMDNS(UpnpHeader searchTarget, int mxSeconds) {
        super(new UpnpRequest(UpnpRequest.Method.MSEARCH), ModelUtil.getInetAddressByName("224.0.0.251"), 5353);
        ...
        this.getHeaders().add(UpnpHeader.Type.HOST, new HostHeader("239.255.255.250", 1900));
    }
